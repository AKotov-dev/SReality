...
Собран с учетом поддержки устаревших ОС.  
Тестирование проходило на VM Mageia-6 2017 года выпуска. Под капотом `SReality` - [sing-box-linux-amd64-musl](https://github.com/SagerNet/sing-box/releases).
